...
2. Implement the <xref:Metalama.Framework.Aspects.OverrideFieldOrPropertyAspect.OverrideProperty> property in plain C#. The accessors of this property will serve as [templates](../Templates.md) defining the way the aspect overrides the accessors of the hand-written field or property.
