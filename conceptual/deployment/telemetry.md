...
Additionally to Telemetry, the use of the software may be subject to _license audit_. License audit is anonymous but mandatory for Metalama Essentials and the self-generated Metalama Trial, and is used to estimate the number of users. When you are using a license key, license audit reports include the id of your license key. If you do not agree with license audit, please contact or sales team and we will provide you with a new license key including a license audit waiver flag.
