...
| `MetalamaLicense` | String | A Metalama license key or license server URL. License key or license server URL provided this way takes precedence over license registered via `metalama` tool.
